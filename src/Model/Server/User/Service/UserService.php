...
namespace EryseClient\Model\Server\User\Service;
...
use EryseClient\Model\Client\Token\Exception\ExpiredTokenException;
use EryseClient\Model\Client\Token\Exception\InvalidTokenException;
use EryseClient\Model\Client\Token\Repository\RememberMeTokenRepository;
...
use EryseClient\Model\Common\Service\MailService;
use EryseClient\Model\Server\User\Entity\User;
use EryseClient\Model\Server\User\Exception\ActivationException;
