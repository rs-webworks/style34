...
namespace EryseClient\Server\UserSettings\Entity;
 ...
 * @ORM\Entity(repositoryClass="EryseClient\Server\UserSettings\Repository\UserSettingsRepository")
 */
class UserSettings implements ServerEntity
{
    use Identifier;
