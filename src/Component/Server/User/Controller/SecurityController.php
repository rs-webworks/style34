...
namespace EryseClient\Component\Server\User\Controller;
...
use EryseClient\Component\Server\User\Form\Type\RegistrationType;
use EryseClient\Model\Client\ProfileSecurity\Exception\ResetPasswordException;
